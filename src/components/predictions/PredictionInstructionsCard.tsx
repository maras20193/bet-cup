      ...
      <CardContent className="space-y-4 text-foreground text-sm">
        <div>
          ...
          <ul className="space-y-1 text-muted-foreground list-disc list-inside">
            ...
            <li>
              Poprawny wynik (zwycięzca lub remis), ale bez trafienia
              dokładnego wyniku -{" "}
              <span className="font-medium text-foreground">
                {outcomePoints} pkt
              </span>
        ...
        <div className="space-y-2 text-muted-foreground">
          ...
          <p>
            ...
            Wynik liczy się po pełnym czasie gry, łącznie z dogrywką. Remis
            jest dozwolony. Jeśli po dogrywce nadal jest remis i o awansie
            zadecydują rzuty karne, oficjalny wynik meczu to remis.
          </p>
        </div>
      </CardContent>
    </Card>
