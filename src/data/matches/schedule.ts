...
const matchKickoffsById = {
  ...
  "gs-a-004": utc(26, 1, 0), // RPA – Korea Południowa
  "gs-a-005": utc(26, 1, 0), // Czechy – Meksyk
  ...
  "gs-c-004": utc(20, 0, 30), // Brazylia – Haiti
  "gs-c-005": utc(25, 22, 0), // Maroko – Haiti
  "gs-c-006": utc(25, 22, 0), // Szkocja – Brazylia

  // Grupa D
  "gs-d-001": utc(13, 1, 0), // USA – Paragwaj
  "gs-d-002": utc(14, 4, 0), // Australia – Turcja
  "gs-d-003": utc(19, 19, 0), // USA – Australia
  "gs-d-004": utc(28, 2, 0), // Paragwaj – Australia
  "gs-d-005": utc(28, 2, 0), // Turcja – USA
  ...
  "gs-e-004": utc(20, 0, 0), // Ekwador – Curacao
  "gs-e-005": utc(26, 20, 0), // Curacao – WKS
  "gs-e-006": utc(26, 20, 0), // Ekwador – Niemcy
  ...
  "gs-f-005": utc(27, 23, 0), // Japonia – Szwecja
  "gs-f-006": utc(27, 23, 0), // Tunezja – Holandia
  ...
  "gs-g-005": utc(29, 3, 0), // Egipt – Iran
  "gs-g-006": utc(29, 3, 0), // Nowa Zelandia – Belgia
  ...
  "gs-h-005": utc(29, 0, 0), // Republika Zielonego Przylądka – Arabia Saudyjska
  "gs-h-006": utc(29, 0, 0), // Urugwaj – Hiszpania
  ...
  "gs-i-005": utc(28, 19, 0), // Norwegia – Francja
  "gs-i-006": utc(28, 19, 0), // Senegal – Irak
  ...
  "gs-j-005": utc(30, 2, 0), // Algieria – Austria
  "gs-j-006": utc(30, 2, 0), // Jordania – Argentyna
  ...
  "gs-k-005": utc(30, 23, 30), // DR Konga – Uzbekistan
  "gs-k-006": utc(30, 23, 30), // Kolumbia – Portugalia

  // Grupa L
  "gs-l-001": utc(17, 20, 0), // Anglia – Chorwacja
  "gs-l-002": utc(17, 23, 0), // Ghana – Panama
  "gs-l-003": utc(23, 20, 0), // Anglia – Ghana
  "gs-l-004": utc(24, 23, 30), // Panama – Chorwacja
  "gs-l-005": utc(29, 21, 0), // Chorwacja – Ghana
  "gs-l-006": utc(29, 21, 0), // Panama – Anglia
